...
const firstLetters = (arr) => {
  return arr.map(joker => {
    console.log(joker);
    return joker.slice(0, 1);
  })
  console.log(joker);
};
...
const allHappy = (arr) => {
  var joker = arr.every(bane => bane.includes(':)'));
  console.log(joker);
  return joker;
};
...
const findAnything = (arr, target) => {
  let joker = arr.filter( bane => bane.includes(target));
  console.log(joker);
  return joker;
};
...
const findEvery = (arr, target) => {
  var joker = arr.every(bane => bane.includes(target));
  console.log(joker);
  return joker;
};
...
const unenrollBrook = (arr) => {
  var bane = 0;
  let joker = arr.map( val => {
    var bane = val.filter( darkness => !darkness.includes('Brook'))
    console.log(bane);
    return bane;
  })
  console.log(joker);
...
const sortByDay = (arr) => {
  ...
  // var all = [];
  // let joker = arr.map( val => {
  //   var bane = val.map( darkness => bane.push(darkness), all.push(darkness)))
  //   console.log(bane);
  //   return bane;
  // })
  // console.log(joker);
...
const characterByIndex = (arr) => {
  ...
  // var all = [];
  // let joker = arr.map( val => {
  //   var bane = val.map( darkness => darkness.splice()))
  //   console.log(bane);
  //   return bane;
  // })
  // console.log(joker);
